...
## Graphing Global_active_power (y) vs. DateTime (x)
with(power.sub, plot(power.sub$DateTime, power.sub$Global_active_power, type = "n", xlab = "", ylab = "Global Active Power (kilowatts)"))
